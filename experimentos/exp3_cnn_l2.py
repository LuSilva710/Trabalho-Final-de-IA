...
# 3. Definição da Arquitetura do Modelo CNN com Regularização L2 (Experimento 3)
...
print("\nResumo da Arquitetura CNN com Regularização L2:")
model.summary()
...
print("\n--- RESULTADOS FINAIS DO EXPERIMENTO 3 ---")
