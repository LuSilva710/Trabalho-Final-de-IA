# Detecção de Tumores Cerebrais - IA
...
* **`outputs/tabelas/`**: Contém a tabela comparativa de métricas em formatos Markdown e CSV.
* **`entrega/`**: Contém o relatório técnico final em Markdown (`relatorio_final.md`) e os links associados.
